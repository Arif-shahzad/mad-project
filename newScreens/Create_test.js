...
export function Create_test({navigation, route}) {
    ...
    const upload_q = async ()=>{
        ...
        .collection("Tests")
        .doc()
        .set({"name":tname, "content":listq})
        .then(()=>{
            Alert.alert("Successfull","Test Created successfully",[{text: "OK", onPress:()=>{navigation.navigate("Test Management")}}]);
        });
    }
