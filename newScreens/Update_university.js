...
export function Update_university({navigation, route}) {
    ...
    const update_u = async ()=>{
        if(name==="" || address==="" || Email==="" || contact==="")
            ...
            .doc(id)
            .update({"name":name, "address":address, "email":Email, "contact":contact})
            .then(()=>{
                Alert.alert(
                    "Successfull",
                    "The university updates successfully",
        ...
        <View style={{flex:1, backgroundColor: "lightgrey"}}>
            <ScrollView>
                ...
                <View style={{flexDirection:"row", justifyContent:"center", alignItems:"center", margin:10}}>
                    <TouchableOpacity style={{margin:10, padding:10, backgroundColor:"red", borderRadius: 10}} onPress = {()=>update_u()}>
                        <Text>FINISH</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
